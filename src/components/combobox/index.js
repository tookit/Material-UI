// Styles
import 'vuetify/src/components/VAutocomplete/VAutocomplete.sass' // Extensions
import VSelect from 'vuetify/lib/components/VSelect/VSelect'
import VAutocomplete from 'vuetify/lib/components/VAutocomplete/VAutocomplete' // Utils

import { keyCodes } from 'vuetify/lib/util/helpers'
// import VSelect, {
//   defaultMenuProps as VSelectMenuProps
// } from 'vuetify/lib/components/VSelect'
// import VTextField from 'vuetify/lib/components/VTextField/VTextField' // Utilities

// import mergeData from 'vuetify/lib/util/mergeData'
// import { keyCodes, getObjectValueByPath } from 'vuetify/lib/util/helpers'
...
export default VAutocomplete.extend({
  ...
  methods: {
    ...
    genChipSelection(item, index) {
      const chip = VSelect.options.methods.genChipSelection.call(
        this,
        item,
        index
    ...
    onFilteredItemsChanged(val, oldVal) {
      ...
      VAutocomplete.options.methods.onFilteredItemsChanged.call(
        this,
        val,
        oldVal
      )
    ...
    setValue(value) {
      VSelect.options.methods.setValue.call(
        this,
        value != null ? value : this.internalSearch
      )
    },
    ...
    updateCombobox() {
      ...
      if (this.internalSearch !== this.getText(this.internalValue))
        this.setValue() // Reset search if using slot
