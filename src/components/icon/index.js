...
import {
  ...
  keys,
  remapInternalIcon
} from 'vuetify/lib//util/helpers' // Types
...
function isFontAwesome5(iconType) {
  return ['fas', 'far', 'fal', 'fab', 'fad'].some((val) =>
    iconType.includes(val)
  )
}
...
const VIcon = mixins(
  ...
  methods: {
    ...
    renderSvgIcon(icon, h) {
      ...
      const viewBoxWidth = this.viewBoxWidth || 24
      const viewBoxHeight = this.viewBoxHeight || 24
      const svgData = {
        attrs: {
